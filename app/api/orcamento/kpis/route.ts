...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Ano Anterior sempre segue a mesma regra do valor de cima (YTD até o mesAtual), com ou
    // sem filtro de mês — senão compara um ano parcial (atual) com o ano completo (anterior),
    // inflando artificialmente a queda.
