          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
            {tipo === 'despesa' ? (
              <>
                ...
                <select aria-label="Secretaria" value={fSec} onChange={e => setFSec(e.target.value)} style={fSec ? { ...selectPill, maxWidth: 'none', width: 'max-content' } : selectPill}>
              ...
              <>
                ...
                <ImpostoTaxaSelect grupos={optsRec.impostosTaxas} value={rIT} onChange={setRIT} style={{ ...selectPill, maxWidth: 'none', width: 'max-content' }} />
              </>
            )}
          </div>
          {atualizacaoBR ? (
